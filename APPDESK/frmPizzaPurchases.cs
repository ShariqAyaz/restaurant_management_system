...
namespace APPDESK
{
    public partial class frmPizzaPurchases : MetroForm
    {
        ...
        int appid = 1033;
        public frmPizzaPurchases(int get_bid, int get_userid)
        {
            InitializeComponent();
            bid = get_bid;
            userid = get_userid;
        ...
        private void btnFetchData_Click(object sender, EventArgs e)
        {
            if (bid == 1)
            {
                ...
                try
                {
                    ...
                    this.ffdT_PIZZEPURCHASE_TA1.Fill(this.eSITERPDataSet._FFDT_PIZZEPURCHASE, Convert.ToInt32(txtST_T.Text));
